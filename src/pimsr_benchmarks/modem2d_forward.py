...
CANONICAL_FREQUENCIES_SHA256 = (
    "ef2a45c075a0ad68ace9fbc5061b4f128ce1a5ee7da38d31397c5af7e4833f76"
)
_CANONICAL_DEPTH_CENTRES_LE_HEX = (
    "0000000000002440900a533b26f62640c78d19fc8f5c2a40ac05c9e4dc432e40c7911560915f3140a96f8568"
    "25f23340146a89793ee63640b675514c4d4a3a40b72279ffe52e3e40b551b79288534140f982be6954e44340"
    "2cc43abc61d64640b89ca94217384a401fa6c69ffd194e403973661b884751400a7c05fd8cd65340395ec5fb"
    "8fc6564041fb5ed6ed255a40cb64a2bb23055e40b6b75cf48f3b6140c037b91bcfc86340f4c68c30c9b66640"
    "869bb4fed0136a406f2b044958f06d408be0d717a02f7140962a3dbf1abb7340c1d2f9520da776403f95f3b2"
    "c0017a40b9b9ea3d9bdb7d4048ac1980b8238140735df9e06fad834009987a5b5c9786407c096beabcef8940"
    "80bd5b90ecc68d40eed36727d91791407b6a5a7ace9f9340976b8242b6879640751e709cc5dd9940f8cd6336"
    "4cb29d402d080c08020ca140e879d1843692a340f6dc89001b78a6405bfb5dc0dacba940e8661626ba9dad40"
    "a1ee531c3300b140de3ed4f9a784b340cfb20e8e8a68b64036c4954dfcb9b940e5e38d553689bd401a1f915e"
    "6cf4c04049f4dcd22277c34051e793e30459c640b8957e3b2aa8c9408c7bebbac074cd40dc2019c9ade8d040"
    "bb596a09a769d34093a4a1f98949d6401f8185816496d940c43a574c5960dd40e8674556f7dce04044b0ff96"
    "345ce340fa40c5c8193ae64015881d17ab84e94004000000004ced40"
)
_CANONICAL_FREQUENCIES_LE_HEX = (
    "7b14ae47e17a843f6dd53bac86789b3f35dbe432886cb23f756433a482b6c83f77d378910693e03f055aa4a0"
    "5f3bf63f96380ca81cd20d400000000000002440"
)


def canonical_depth_centres_m() -> np.ndarray:
    """Return the public depth axis without platform-dependent libm calls."""

    return np.frombuffer(bytes.fromhex(_CANONICAL_DEPTH_CENTRES_LE_HEX), dtype="<f8").copy()


def canonical_frequencies_hz() -> np.ndarray:
    """Return the public frequency axis as exact little-endian values."""

    return np.frombuffer(bytes.fromhex(_CANONICAL_FREQUENCIES_LE_HEX), dtype="<f8").copy()
